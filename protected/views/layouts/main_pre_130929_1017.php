	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				// specific to projectapp
				array('label'=>'Project', 'url'=>array('/project/index')),
				array('label'=>'ProjectType', 'url'=>array('/projectType/index')),
				array('label'=>'Task', 'url'=>array('/task/index')),
				array('label'=>'TaskType', 'url'=>array('/taskType/index')),
				array('label'=>'TaskPriority', 'url'=>array('/taskPriority/index')),
				array('label'=>'BiLink', 'url'=>array('/bilink/index')),
				
				
				// from flex_post
				//array('label'=>'Instance', 'url'=>array('/instance/index')),
