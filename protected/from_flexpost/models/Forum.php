...
class Forum extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('views, votes, inserter, last_editor', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, title, description, weight, views, votes, status, insert_datetime, inserter, last_edit_datetime, last_editor', 'safe', 'on'=>'search'),
		);
	}
